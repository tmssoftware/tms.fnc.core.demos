...
uses
  FMX.TMSFNCPDFLib, FMX.TMSFNCPDFCoreLibBase, FMX.TMSFNCGraphics, FMX.TMSFNCGraphicsTypes, IOUtils;
...
begin
  ...
  try
    s := 'Lorem Ipsum is simply <b>dummy</b> text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy'
      ...
      + 'It has survived not only five <font size="16" color="gcRed">centuries</font>, but also the <sup>leap</sup> <sub>into</sub> <u>electronic</u> typeset'
      ...
      + ' was popularised in the 1960s with the <font size="12"><a href="http://www.tmssoftware.com">release</a></font> of Letraset sheets containing Lorem Ipsum passages, and more recently with des'
    ...
    p.Graphics.DrawImageWithName('Sample.jpg', RectF(rh.Left + 10, tr.Bottom + 10, rh.Left + 110, tr.Bottom + 110));
    p.Graphics.DrawImageWithName('Sample.jpg', RectF(rh.Left + 120, tr.Bottom + 10, rh.Left + 220, tr.Bottom + 110), True, True, itJPG, 0.1);

    p.Graphics.DrawImageWithName('Sample2.jpg', PointF(rh.Left + 240, tr.Bottom + 10));
    p.Graphics.DrawImageWithName('Sample2.jpg', RectF(rh.Left + 420, tr.Bottom + 10, rh.Left + 520, tr.Bottom + 110), True, True, itJPG, 0.1);
