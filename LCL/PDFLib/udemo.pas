...
uses
  ...
  ExtCtrls, LCLTMSFNCBitmapContainer;
...
uses
  LCLTMSFNCPDFLib, LCLTMSFNCTypes, LCLTMSFNCGraphicsTypes, LCLTMSFNCGraphics, LCLTMSFNCPDFCoreLibBase;
...
begin
  ...
  try
    ...
    tr := p.Graphics.DrawHTMLText(UTF8Decode(s), r);
    ...
    try
      ...
      p.Graphics.DrawText(UTF8Decode(st.Text), RectF(rh.Left + 10, tr.Bottom + 10, rh.Right, tr.Bottom + 150), 3);
    finally
      st.Free;
    end;
...
//
    ...
    p.Graphics.Font.Color := gcBlack;
    p.Graphics.Font.style := [];
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Belarusian</font></b>: Прывітанне Сусвет'), PointF(rh.Left + 10, tr.Bottom + 10));
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Chinese</font></b>: 你好，世界'), PointF(rh.Left + 10, tr.Bottom + 30));
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Thai</font></b>: สวัสดีชาวโลก'), PointF(rh.Left + 10, tr.Bottom + 50));

    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Kyrgyz</font></b>: салам дүйнө'), PointF(rh.Left + 210, tr.Bottom + 10));
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Japanese</font></b>: こんにちは世界'), PointF(rh.Left + 210, tr.Bottom + 30));
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Telugu</font></b>: హలో వరల్డ్'), PointF(rh.Left + 210, tr.Bottom + 50));

    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Vietnamese</font></b>: Chào thế giới'), PointF(rh.Left + 410, tr.Bottom + 10));
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Greek</font></b>: Γειά σου Κόσμε'), PointF(rh.Left + 410, tr.Bottom + 30));
    p.Graphics.DrawHTMLText(UTF8Decode('<b><font color="gcDarkOrange">Lao</font></b>: ສະ​ບາຍ​ດີ​ຊາວ​ໂລກ'), PointF(rh.Left + 410, tr.Bottom + 50));
