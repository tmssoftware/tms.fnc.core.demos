...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Generics.Collections, VCL.TMSFNCCloudBase, VCL.TMSFNCUtils, JSON,
...
procedure TForm3.DoGetMovieImage(const ARequestResult: TTMSFNCCloudBaseRequestResult);
var
  ms: TMemoryStream;
begin
