...
type
  ...
  protected
    ...
    function GetRecordValue(ARecord: TValue; AField: string): ValueType;
...
function TMyDataLink.GetRecordValue(ARecord: TValue; AField: string): ValueType;
var
  ctx: TRttiContext;
  rttitype: TRttiType;
...
const
  E_NOINTERFACE = HResult($00024000);
begin
